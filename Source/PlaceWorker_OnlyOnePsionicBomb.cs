/*
 * This file is part of Psionic Bomb, a Better Rimworlds Project.
 *
...
{
    class PlaceWorker_OnlyOnePsionicBomb : PlaceWorker_OnlyOneBuilding
    {
        public override AcceptanceReport AllowsPlacing(BuildableDef checkingDef, IntVec3 loc, Rot4 rot, Map map, Thing thingToIgnore = null, Thing thing = null)
        {
            ...
            if (
               ...
               || map.listerBuildings.ColonistsHaveBuilding(ThingDef.Named("BRW_PsionicBombCaster"))
               )
            {
                return "You can only build one Psionic Bomb Caster per map.";
            }
